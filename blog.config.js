...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '一个平平无奇的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.ikiss.eu.org', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '信息分享, 社区', // 网站关键词 英文逗号隔开
  ...
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '这是YongBlog分享社区', // 站点描述，被notion中的页面描述覆盖
